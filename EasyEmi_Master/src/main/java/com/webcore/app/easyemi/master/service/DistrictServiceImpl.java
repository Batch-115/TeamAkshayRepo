...
public class DistrictServiceImpl implements DistrictService{
	...
	@Override
	public List<DistrictListDto> fetchDistrictList() {
		List<DistrictListDto> districtList=dr.getDistrictList();
		return districtList;
	}

	@Override
	public DistStateCountry fetchDistStateCountry(int id) {
		DistStateCountry distStateCountry=dr.getDistStateCountry(id);
